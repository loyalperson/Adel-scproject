...
<div class="app-sidebar-logo px-6" id="kt_app_sidebar_logo">
	<!--begin::Logo image-->
	<a href="{{ route('dashboard') }}" style="display: flex; flex-direction:row; gap: 10px;">
		<img alt="Logo" src="{{ image('logos/whatsapp-logo.svg') }}" class="h-50px app-sidebar-logo-default" />
		<img alt="Logo" src="{{ image('logos/whatsapp-logo.svg') }}" class="h-20px app-sidebar-logo-minimize" />
