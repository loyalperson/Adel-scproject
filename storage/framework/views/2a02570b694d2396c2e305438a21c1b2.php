                        ...
                        <div class="card card-pricing">
                            <div class="card-body text-center">
                                ...
                                <ul class="list-unstyled features">
                                    <li>Up to <?php echo e(config('quotas.quota1')); ?> Monthly Searches <span class="text-success">&#10003;</span></li>
                                </ul>
                    ...
                    <div class="col-md-4 mb-4">
                        <div class="card card-pricing">
                            <div class="card-body text-center">
                                ...
                                <ul class="list-unstyled features">
                                    <li>Up to <?php echo e(config('quotas.quota2')); ?> Monthly Searches <span class="text-success">&#10003;</span></li>
                                </ul>
                                <button class="btn btn-primary btn-select">Select</button>
                            </div>
                        </div>
...
<?php endif; ?><?php /**PATH /home/scanlolo/public_html/scproject.muthallath.com/resources/views/pages/apps/subscription/index.blade.php ENDPATH**/ ?>