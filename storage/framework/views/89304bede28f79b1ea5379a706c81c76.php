...
<div class="card card-flush bgi-no-repeat bgi-size-contain bgi-position-x-end h-md-50 mb-5 mb-xl-10" style="background-color: #F1416C;background-image:url('assets/media/patterns/vector-1.png')">
	...
	<div class="card-header pt-5">
		<form method="POST" action="<?php echo e(route('updateQuotas')); ?>">
			<?php echo csrf_field(); ?>
			<!-- Quota 1 -->
			<div class="card-title d-flex flex-column">
				<!-- Amount Input -->
				<input type="number" name="quota1" class="form-control" value="<?php echo e(config('quotas.quota1')); ?>" />
				<!-- Subtitle -->
			...
			<div class="card-title d-flex flex-column">
				<!-- Amount Input -->
				<input type="number" name="quota2" class="form-control" value="<?php echo e(config('quotas.quota2')); ?>" />
				<!-- Subtitle -->
...
<!--end::Card widget 20-->
<?php /**PATH /home/scanlolo/public_html/scproject.muthallath.com/resources/views/partials/widgets/cards/_widget-20.blade.php ENDPATH**/ ?>